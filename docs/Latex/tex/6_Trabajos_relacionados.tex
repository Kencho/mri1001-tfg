...
\caption{Captura de pantalla de un nivel del videojuego Celeste. Enlace a la página de Wikipedia de Celeste: \url{https://es.wikipedia.org/wiki/Celeste_(videojuego)}}
\end{figure}
...
\caption{Captura de pantalla de un nivel del videojuego Super Meat Boy. Enlace a la página de Wikipedia de Super Meat Boy: \url{https://es.wikipedia.org/wiki/Super_Meat_Boy}}
\end{figure}
