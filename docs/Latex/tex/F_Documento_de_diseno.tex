...
\textit{El sonido de selección de los botones ha sido obtenido del enlace: \url{https://opengameart.org/content/botton-sound-pack}}
...
\textit{La música que suena mientras se esta en estas escenas es 01 B-arb del album B-arb, pertenece a Axel Bermudez y se puede encontrar en el siguiente enlace (junto con el resto de canciones del album del que se ha sacado la canción): \url{https://axelbermudez.bandcamp.com/releases}}
